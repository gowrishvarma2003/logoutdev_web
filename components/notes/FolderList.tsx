  ...
  return (
    <div>
      <div className="mb-1 flex items-center justify-between px-2">
        <span className="text-[11px] font-semibold uppercase tracking-wide text-text-disabled">Folders</span>
        <button
      ...
      {folders.folders.length === 0 && !folders.loading ? (
        <p className="px-2 py-1 text-xs text-text-disabled">No folders yet.</p>
      ) : (
            ...
            return (
              <li key={folder.id} className="group relative" data-folder-menu-root>
                ...
                >
                  ...
                  {folder.note_count ? <span className="text-xs text-text-disabled">{folder.note_count}</span> : null}
                </Link>
                <button
