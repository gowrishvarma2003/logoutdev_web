...
export default function DiscussionThreadCard({
  ...
  return (
    <Link
      ...
      className="group block border-b border-border-default/60 hover:bg-surface/40 transition-colors"
    >
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap text-xs mb-2">
              ...
              <span className="text-text-disabled">{formatRelativeTime(discussion.created_at)}</span>
            ...
            <h3 className="text-sm font-semibold text-text-primary group-hover:text-sky-300 transition-colors mb-1.5 leading-snug">
              {discussion.title}
            </h3>

            {discussion.body && (
              <RichText text={discussion.body} className="text-sm text-text-muted leading-relaxed line-clamp-3 whitespace-pre-line" />
            )}

            <div className="mt-3 flex items-center gap-4 text-xs text-text-disabled">
