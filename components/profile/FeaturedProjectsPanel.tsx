...
import { RocketIcon, ChevronRightIcon } from "@/components/ui/Icons";
...
export default function FeaturedProjectsPanel({
  ...
  return (
    <section aria-label="Featured projects">
      ...
      {projects.length === 0 ? (
        <p className="text-sm text-zinc-600 italic">No featured projects yet.</p>
      ) : (
        <div className="flex flex-col gap-2.5">
          {projects.map(({ id, space }) => (
            ...
            >
              ...
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-sky-500/20 to-violet-500/20 border border-zinc-700 flex items-center justify-center text-sm font-bold text-white shrink-0 mt-0.5">
