...
export default function ProfileBandChip({ band, score, className = "" }: ProfileBandChipProps) {
  const style = BAND_STYLES[band] ?? BAND_STYLES.Early;
  return (
    <span
