/** Centralised inline SVG icon set — all icons accept className for sizing/color. */
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48L4.5 20.25l3.227-.807A9.8 9.8 0 0012 20.25z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.125 8.625a2.25 2.25 0 114.276 1.006c-.286.636-.84 1.03-1.36 1.436-.67.523-1.291 1.14-1.291 2.308m-.375 2.625h.008v.008h-.008v-.008z"
      />
    </svg>
  );
}
...
export function PencilSquareIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ChatIcon({ className = "w-[18px] h-[18px]" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function RepeatIcon({ className = "w-[18px] h-[18px]" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function PinSlashIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 16 16">
      <path d="m1.655.595 13.75 13.75q.22.219.22.53 0 .311-.22.53-.219.22-.53.22-.311 0-.53-.22L.595 1.655q-.22-.219-.22-.53 0-.311.22-.53.219-.22.53-.22.311 0 .53.22ZM.72 14.22l4.5-4.5q-.219-.22-.53-.22.311 0 .53.22.22.219.22.53 0 .311-.22.53l-4.5 4.5q-.219.22-.53.22-.311 0-.53-.22-.22-.219-.22-.53 0-.311.22-.53Z" />
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M15.75 5.25a3.75 3.75 0 11-6.75 2.297L3.75 12.797V15h2.203v2.25h2.25v2.25h2.297l5.25-5.25a3.75 3.75 0 000-9z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.081 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M17.25 6.75L21 12l-3.75 5.25M6.75 6.75L3 12l3.75 5.25M13.5 4.5L10.5 19.5"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75zm0-10C3 2.504 3.504 2 4.125 2h2.25C7.004 2 7.5 2.504 7.5 3.125v16.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875V3.125zm8.25 4C11.25 6.504 11.754 6 12.375 6h2.25c.621 0 1.125.504 1.125 1.125v12.75C15.75 20.496 15.246 21 14.625 21h-2.25a1.125 1.125 0 0 1-1.125-1.125V7.125zm8.25 2C19.5 8.504 20.004 8 20.625 8h2.25c.621 0 1.125.504 1.125 1.125v10.75C24 20.496 23.496 21 22.875 21h-2.25a1.125 1.125 0 0 1-1.125-1.125V9.125z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6 12a3 3 0 100-6 3 3 0 000 6zm0 0v6m6-12a3 3 0 100 6 3 3 0 000-6zm6 3v6a3 3 0 01-3 3H9"
      />
    </svg>
  );
}
...
export function ArchiveBoxIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ArrowUturnLeftIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function QuoteIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      ...
      strokeWidth={1.8}
    >
      <path strokeLinecap="round" d="M5 5v14" />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10 7.5h9M10 12h9M10 16.5h6"
      />
    </svg>
  );
}
...
export function TaskListIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
      ...
      strokeWidth={1.8}
    >
      <rect x="3" y="4.5" width="4.5" height="4.5" rx="1" />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="m4 6.75 1 1 1.75-1.75"
      />
      <rect x="3" y="14.5" width="4.5" height="4.5" rx="1" />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.5 6.75h10M10.5 16.75h10"
      />
    </svg>
  );
}

export function ListNumberedIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 6.75h10.5M9.75 12h10.5m-10.5 5.25h10.5"
      />
      <text
        x="2"
        y="8.6"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M15 15l6-6m0 0-6-6m6 6H9a6 6 0 000 12h3"
      />
    </svg>
  );
}
