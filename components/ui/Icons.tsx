...
export function QuestionMarkCircleIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48L4.5 20.25l3.227-.807A9.8 9.8 0 0012 20.25z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 8.625a2.25 2.25 0 114.276 1.006c-.286.636-.84 1.03-1.36 1.436-.67.523-1.291 1.14-1.291 2.308m-.375 2.625h.008v.008h-.008v-.008z" />
    </svg>
  );
}
...
export function HeartIcon({ className = "w-[18px] h-[18px]", filled = false }: IconProps & { filled?: boolean }) {
  return filled ? (
...
export function BarChartIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75zm0-10C3 2.504 3.504 2 4.125 2h2.25C7.004 2 7.5 2.504 7.5 3.125v16.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875V3.125zm8.25 4C11.25 6.504 11.754 6 12.375 6h2.25c.621 0 1.125.504 1.125 1.125v12.75C15.75 20.496 15.246 21 14.625 21h-2.25a1.125 1.125 0 0 1-1.125-1.125V7.125zm8.25 2C19.5 8.504 20.004 8 20.625 8h2.25c.621 0 1.125.504 1.125 1.125v10.75C24 20.496 23.496 21 22.875 21h-2.25a1.125 1.125 0 0 1-1.125-1.125V9.125z" />
    </svg>
  );
}
