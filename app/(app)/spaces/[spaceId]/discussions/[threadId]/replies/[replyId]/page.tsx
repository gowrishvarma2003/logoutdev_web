...
export default function DiscussionReplyThreadPage({
  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      {/* ── Breadcrumb nav ────────────────────────────────────────────── */}
      <div className="sticky top-0 z-10 px-4 py-3 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur-sm">
        <Link
          href={`/spaces/${spaceId}/discussions/${threadId}`}
      ...
      {/* ── Focus reply card ──────────────────────────────────────────── */}
      <div className="px-5 py-4 border-b border-zinc-800 bg-zinc-900/25">
      ...
      {/* ── Replies header ────────────────────────────────────────────── */}
      <div className="flex items-center gap-3 px-5 py-3 border-b border-zinc-800/60 bg-zinc-950">
