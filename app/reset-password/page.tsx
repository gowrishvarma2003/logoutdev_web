  ...
  return (
    <main className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-surface border-r border-border-subtle p-12">
        ...
        <p className="text-xs text-text-disabled">© {new Date().getFullYear()} LogoutDev</p>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-5">
            {!verificationToken ? (
              <>
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="ld-input ld-field px-4 focus:ring-2 focus:ring-white/10 transition disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>

                {challengeToken ? (
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="otp" className="text-xs font-semibold uppercase tracking-wide text-text-muted">Verification code</label>
              ...
              <>
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="newPassword" className="text-xs font-semibold uppercase tracking-wide text-text-muted">
                    New password
                  </label>
